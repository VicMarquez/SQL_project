...
USE sql_meta
######################## Vistas ##########################
# 1) vista_fenologia_mismatch: tiene como objetivo mostrar las fenologias de las plantas y polinizadores que esten en lo mismos sitios. Es útil
# para detectar posibles desajustes planta-polinizador (mismatch)
...
FROM estudio e
LEFT JOIN planta pl ON pl.id_estudio = e.id_estudio # left join me asegura que todos los sitios aparezacan listados. 
